           ...
           <Field>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 space-y-1.5">
                  <label
                    className="flex items-center justify-center gap-2 w-full h-9 rounded-lg border border-dashed border-gray-300 bg-gray-50 cursor-pointer hover:bg-gray-100 hover:border-indigo-300 transition-colors text-sm text-muted-foreground hover:text-indigo-500"
                  >
                    <ImagePlus size={14} />
                    Chọn ảnh
                    <input
